...
const curiosities = [
  {
    id: 0,
    front: '🛍️',
    question: 'Quanto tempo uma sacola plástica pode permanecer no ambiente?',
    answer: 'Até 20 anos, segundo as referências usadas nesta cartilha. E isso não significa que ela desapareça por completo: ao longo do tempo, pode se fragmentar em partículas menores.',
    color: '#EF4444',
  ...
  },
  {
    ...
    answer: 'Porque costuma ter um uso muito curto, mas pode permanecer no ambiente por anos e continuar causando impacto mesmo quando se fragmenta em partículas menores.',
    color: '#F97316',
  ...
  },
  {
    ...
    answer: 'Não existe um número fixo: quando entra na rotina semanal de compras, uma ecobag reutilizada com frequência pode substituir muitas sacolas descartáveis ao longo do tempo.',
    color: '#4ADE80',
