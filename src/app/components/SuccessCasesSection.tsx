...
const cases = [
  {
    ...
    description:
      'São Paulo foi pioneira com a proibição do uso de sacolas plásticas em supermercados. Após resistência inicial, a lei se tornou referência nacional com resultados expressivos.',
    before: {
      bags: '8 bilhões',
      label: 'sacolas/ano antes da lei',
      recycling: '3%',
    },
    after: {
      reduction: '80%',
      label: 'de redução no uso de sacolas',
      ecobags: '35M',
  ...
  },
  {
    ...
    image: CITY_IMAGE,
    year: '2015',
    law: 'Decreto Municipal',
    description:
      'O Rio de Janeiro implementou campanhas de conscientização em parceria com supermercados e ONGs ambientais, focando na educação antes da punição.',
    before: {
      bags: '5 bilhões',
      label: 'sacolas/ano antes da lei',
      recycling: '2%',
    ...
    after: {
      reduction: '65%',
      label: 'de redução nas praias e parques',
      ecobags: '18M',
